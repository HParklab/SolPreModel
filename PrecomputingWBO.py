...
# ──────────────────────────────────────────────────────────
XYZ_DIR  = "/Users/cxxoseo/Desktop/SolPreModel/InputData/SMILEStoXYZ.curated/"
WBO_DIR  = "/Users/cxxoseo/Desktop/SolPreModel/WBO/"
COSMO_DIR  = "/Users/cxxoseo/Desktop/SolPreModel/COSMO/"
LOG_PATH = os.path.join(WBO_DIR, "xtb_run_log_re4.csv")
RE_LOG_PATH = os.path.join(WBO_DIR, "xtb_run_log_re5.csv")

os.makedirs(WBO_DIR, exist_ok=True)
...
def compute_cosmo(xyz_path, new_name, mol_id):
    ...
    try:
        ...
        esp_cosmo = os.path.join(WBO_DIR, "xtb_esp.cosmo")
...
for mol_id in tqdm(priority_ids, desc="COSMO 계산 진행중", ncols=100):
    ...
    out_name = os.path.join(COSMO_DIR, f"{mol_id}_cosmo")
